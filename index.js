class SwitchbleArea {
    currentTab = null;
    activeTabClassName = 'SwitchableArea-tab__active';
    activeAreaClassName = 'SwitchableArea-area__active';
    selectorTabClassname = this._createSelector('SwitchableArea-tab');
    ...
    init() {
        $(this.selectorTabClassname).on('click', (event) => {
            ...
            $(this._createSelector(this.activeAreaClassName)).removeClass(this.activeAreaClassName);
            $(this._createSelector(event.target.id.replace('tab', 'area'),
                true)).addClass(this.activeAreaClassName);
        });
    }
